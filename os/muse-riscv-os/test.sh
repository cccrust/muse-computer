...
check "cgreuse PASS"
check "pkg-installed hello 1.0"
check "PKGLS hello 1.0"
check "hello-from-pkg"
check "pkg-hello-txt"
check "pkg-removed hello"
check "pkg-installed farewell 1.0"
check "PKGLS farewell 1.0"
check "farewell-marker"
check "needed by farewell"
check "dependency cycle"
check "pkg-removed farewell"
check "pkg-installed fortune 1.0"
...
check "CTRPS ftest.*mem=100000"
check "stopped ftest (killed 2)"
check "removed ftest"
